...
# оператор id() показывает числовой адрес объекта по которому он лежит в памяти
# оператор is сравнивает два объекта по адресам в памяти
# оператор == сравнивает два объекта по совпадению значений которые в них лежаь
#  Однвко
a1 = 23
a2 = 23
# True
print(a1 == a2)
# True a1 и a2  ссылаются на один и тот же объект?
print(a1 is a2)
